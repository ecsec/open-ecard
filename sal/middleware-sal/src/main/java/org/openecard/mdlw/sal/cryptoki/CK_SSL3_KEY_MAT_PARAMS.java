 ...
 */
public class CK_SSL3_KEY_MAT_PARAMS extends Structure {
	/** C type : CK_ULONG */
	...
	public CK_SSL3_KEY_MAT_PARAMS() {
	 ...
	 protected List<String> getFieldOrder() {
		return Arrays.asList("ulMacSizeInBits", "ulKeySizeInBits", "ulIVSizeInBits", "bIsExport", "RandomInfo", "pReturnedKeyMaterial");
	}
	/**
	 ...
	 * @param pReturnedKeyMaterial C type : CK_SSL3_KEY_MAT_OUT_PTR
	 */
	public CK_SSL3_KEY_MAT_PARAMS(long ulMacSizeInBits, long ulKeySizeInBits, long ulIVSizeInBits, byte bIsExport, CK_SSL3_RANDOM_DATA RandomInfo, org.openecard.mdlw.sal.cryptoki.CK_SSL3_KEY_MAT_OUT.ByReference pReturnedKeyMaterial) {
		super();
		this.ulMacSizeInBits = ulMacSizeInBits;
		this.ulKeySizeInBits = ulKeySizeInBits;
		this.ulIVSizeInBits = ulIVSizeInBits;
	...
	public CK_SSL3_KEY_MAT_PARAMS(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends CK_SSL3_KEY_MAT_PARAMS implements Structure.ByReference {
		
	};
	public static class ByValue extends CK_SSL3_KEY_MAT_PARAMS implements Structure.ByValue {
