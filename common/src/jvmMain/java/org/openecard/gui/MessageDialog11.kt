...
interface MessageDialog {
     ...
     */
    fun showMessageDialog(message: String?, title: String?): MessageDialogResult?
     ...
     * @return MessageDialogResult with no return value.
     */
    fun showMessageDialog(message: String?, title: String?, messageType: DialogType?): MessageDialogResult?
     ...
     */
    fun showConfirmDialog(message: String?, title: String?): MessageDialogResult?
     ...
     * @return MessageDialogResult with a result value set conforming to the option selected by the user.
     */
    fun showConfirmDialog(message: String?, title: String?, optionType: OptionType?): MessageDialogResult?
     ...
     */
    fun showConfirmDialog(
        message: String?, title: String?, optionType: OptionType?, messageType: DialogType?,
        iconData: ByteArray?
    ): MessageDialogResult?
     ...
     */
    fun showInputDialog(message: String?, title: String?): MessageDialogResult?
     ...
     * @return a MessageDialogResult with the user's input.
     */
    fun showInputDialog(message: String?, title: String?, initialValue: String?): MessageDialogResult?
     ...
     */
    fun showInputDialog(
        message: String?, title: String?, messageType: DialogType?, iconData: ByteArray?,
        initialSelectionIndex: Int, vararg selectionValues: String?
    ): MessageDialogResult?
    ...
    fun showOptionDialog(
        message: String?, title: String?, optionType: OptionType?, messageType: DialogType?,
        iconData: ByteArray?, vararg options: String?
    ): MessageDialogResult?
}
