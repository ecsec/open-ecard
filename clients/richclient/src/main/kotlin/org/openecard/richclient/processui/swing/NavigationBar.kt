...
import org.openecard.richclient.processui.swing.common.GUIConstants
...
class NavigationBar(
	...
	override fun hasFocus(): Boolean = backButton.hasFocus() || nextButton.hasFocus() || cancelButton.hasFocus()
