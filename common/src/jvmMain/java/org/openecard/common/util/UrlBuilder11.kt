...
class UrlBuilder {
    ...
    private constructor(
        encoder: UrlEncoder, scheme: String, userInfo: String, host: String, port: Int, path: String,
        queryParams: HashMap<String?, String?>, fragment: String
    ) {
     ...
     */
    fun scheme(@Nonnull scheme: String): UrlBuilder {
     ...
     */
    fun userInfo(@Nonnull userInfo: String?): UrlBuilder {
        val b = UrlBuilder(this)
        b.userInfo = userInfo
        return b
    }
     ...
     */
    fun host(@Nonnull host: String): UrlBuilder {
        val b = UrlBuilder(this)
        b.host = host
        return b
    }
     ...
     * @return A copy of the UrlBuilder with the path part modified.
     */
    fun addPathSegment(@Nonnull segment: String): UrlBuilder {
        var segment = segment
        val b = UrlBuilder(this)
     ...
     */
    fun queryParam(@Nonnull key: String?, value: String?): UrlBuilder {
     ...
     * @return A copy of the UrlBuilder with added query parameter.
     */
    fun queryParamUrl(@Nonnull key: String?, value: String?): UrlBuilder {
     ...
     * @return A copy of the UrlBuilder with added query parameter.
     */
    fun queryParam(@Nonnull key: String?, value: String?, overwrite: Boolean): UrlBuilder {
        val b = UrlBuilder(this)
     ...
     * @return A copy of the UrlBuilder with added query parameter.
     */
    fun queryParamUrl(@Nonnull key: String?, value: String?, overwrite: Boolean): UrlBuilder {
        val b = UrlBuilder(this)
        if (overwrite || !queryParams.containsKey(key)) {
    ...
    private fun addQueryInt(@Nonnull k: String, v: String?) {
        var k: String? = k
        var v = v
    ...
    companion object {
         ...
         */
        @Throws(URISyntaxException::class)
        fun fromUrl(baseUrl: URL): UrlBuilder {
