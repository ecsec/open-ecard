...
abstract class ActivationError : I18nException {
	...
	constructor(result: BindingResult, message: String) : super(message) {
		bindingResult = result.setResultMessage(localizedMessage)
	}

	constructor(result: BindingResult, message: String, cause: Throwable?) : super(message, cause) {
		bindingResult = result.setResultMessage(localizedMessage)
	}
	...
	companion object {
		protected val LANG: I18n = I18n.getTranslation("chipgateway")
	}
}
