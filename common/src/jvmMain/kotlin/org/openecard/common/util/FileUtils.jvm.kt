...
object FileUtils {
	...
	@JvmStatic
    @Throws(FileNotFoundException::class, IOException::class)
    fun toByteArray(file: File, limit: Int): ByteArray {
    ...
    fun toString(file: File, charset: String = "UTF-8"): String {
    ...
    fun toString(inStream: InputStream, charset: String = "UTF-8"): String {
        return String(toByteArray(inStream), charset(charset))
    }
 ...
 * http://www.uofr.net/~greg/java/get-resource-listing.html](http://www.uofr.net/~greg/java/get-resource-listing.html) and modified for our needs.
    ...
    fun getResourceListing(clazz: Class<*>, path: String): Map<String, URL> {
    ...
    private fun getSubdirFileListing(dir: File, base: String): TreeMap<String, URL> {
    ...
    @JvmStatic
	@Throws(UnsupportedEncodingException::class, IOException::class)
    fun getResourceFileListing(clazz: Class<*>, prefix: String, listFile: String): Map<String, URL> {
        val fileStream = resolveResourceAsStream(clazz, listFile)
    ...
    @JvmStatic
	@Throws(IOException::class)
    fun resolveResourceAsStream(clazz: Class<*>, name: String): InputStream? {
     ...
     */
	@JvmStatic
	fun resolveResourceAsURL(clazz: Class<*>, name: String): URL? {
    ...
    @JvmStatic
	@Throws(IOException::class)
    fun resolveResourceAsStream(loader: ClassLoader, name: String): InputStream? {
     ...
     */
    fun resolveResourceAsURL(loader: ClassLoader, name: String): URL? {
