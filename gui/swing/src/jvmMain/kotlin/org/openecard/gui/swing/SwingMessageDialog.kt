...
class SwingMessageDialog : MessageDialog {
    ...
    override fun showMessageDialog(msg: String, title: String?): MessageDialogResult {
        return showMessageDialog(msg, title, DialogType.INFORMATION_MESSAGE)
    }

    override fun showMessageDialog(msg: String, title: String?, msgType: DialogType): MessageDialogResult {
        return showMessageDialog(msg, title, msgType, null)
    }

    override fun showMessageDialog(
        msg: String, title: String?, msgType: DialogType,
        iconData: ByteArray?
    ): MessageDialogResult {
    ...
    override fun showConfirmDialog(msg: String, title: String?): MessageDialogResult {
        return showConfirmDialog(msg, title, OptionType.YES_NO_CANCEL_OPTION)
    }

    override fun showConfirmDialog(msg: String, title: String?, optionType: OptionType): MessageDialogResult {
    ...
    override fun showConfirmDialog(
        msg: String, title: String?, optionType: OptionType, msgType: DialogType,
        iconData: ByteArray?
    ): MessageDialogResult {
        var msg = msg
    ...
    override fun showInputDialog(msg: String, title: String): MessageDialogResult {
        return showInputDialog(msg, title, "")
    }

    override fun showInputDialog(msg: String, title: String, initialValue: String?): MessageDialogResult {
