 ...
 */
class CertificateDescription private constructor(seq: ASN1Sequence) {
     ...
     */
    fun getCommCertificates(): List<ByteArray> {
        return commCertificates!!
    }
     ...
     *
     */
    fun getTermsOfUsageMimeType(): String {
