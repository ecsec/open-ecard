...
public class CHATStep {
    ...
    public CHATStep(ContentMap content) {
	this.requiredCHAT = (CHAT) content.get(ContentMap.ELEMENT.REQUIRED_CHAT);
	this.optionalCHAT = (CHAT) content.get(ContentMap.ELEMENT.OPTIONAL_CHAT);;
    }
