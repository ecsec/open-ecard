...
class SemanticVersion(
	...
	fun isOlder(v: SemanticVersion): Boolean = v.isNewer(this)

	fun isSame(v: SemanticVersion): Boolean = this.compareTo(v) == 0
...
private fun cleanVersionString(version: String?): String = version ?: UNKNOWN_VERSION
