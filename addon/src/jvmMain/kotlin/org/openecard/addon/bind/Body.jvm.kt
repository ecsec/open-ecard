...
protected constructor(
	 ...
	 */
	fun setValue(value: ByteArray?, encoding: Charset?, mimeType: String?) {
		if (value == null) {
			this.encoding = null
			this.mimeType = null
		} else {
	 ...
	 * @param mimeType The MIME type of the value.  `null` values are permitted.
	 */
	fun setValue(value: String?, mimeType: String?) {
	 ...
	 * @param mimeType The MIME type of the value.  `null` values are permitted.
	 */
	fun setValue(value: ByteArray?, mimeType: String?) {
