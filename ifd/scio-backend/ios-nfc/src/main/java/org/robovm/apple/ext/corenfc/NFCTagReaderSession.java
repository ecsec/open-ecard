...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/NFCTagReaderSession/*</name>*/ 
    ...
    public NFCTagReaderSession(NFCPollingOption pollingOption, NFCTagReaderSessionDelegate delegate, DispatchQueue queue) { 
        super((SkipInit) null);
        initObject(initWithPollingOption$delegate$queue$(pollingOption, delegate, queue));
    }
    /*</constructors>*/
    /*<properties>*/
    /**
     ...
     */
    @Method(selector = "initWithPollingOption:delegate:queue:")
    protected native @Pointer long initWithPollingOption$delegate$queue$(NFCPollingOption pollingOption, NFCTagReaderSessionDelegate delegate, DispatchQueue queue);
    /**
     * @since Available in iOS 13.0 and later.
     */
