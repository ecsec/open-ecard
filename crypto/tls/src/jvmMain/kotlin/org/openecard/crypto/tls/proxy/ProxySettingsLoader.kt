...
class ProxySettingsLoader {
        ...
        synchronized(ProxySettingsLoader::class.java) {
            ...
            when (scheme) {
                ...
                "NO PROXY" -> selector = NoProxySelector()
                    ...
                    val proxies: List<Proxy> = if (ps != null) ps.select(URI.create("https://google.com/")) else emptyList()
                    setSocksProperties(proxies)
                    setHttpProperties(proxies)

                    selector = UpdatingProxySelector(object : SelectorSupplier {
    ...
    private fun getProxyAddress(type: Proxy.Type, proxies: List<Proxy>): InetSocketAddress? {
    ...
    private fun createAuthenticator(user: String, pass: String): Authenticator {
...
//		    String password = System.getProperty(prot + ".proxyPassword", "");
    ...
    companion object {
        init {
            com.github.markusbernhardt.proxy.util.Logger.setBackend(object :
