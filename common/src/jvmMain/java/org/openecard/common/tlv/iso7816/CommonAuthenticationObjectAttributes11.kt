 ...
 */
class CommonAuthenticationObjectAttributes(tlv: TLV) : TLVType(tlv) {
    ...
    fun getAuthReference(): Int {
        return if (authReference != null) {
            authReference
        } else {
            -1
        }
    ...
    fun getSecurityEnvironmentID(): Int {
        return if (securityEnvironmentID != null) {
