 ...
 * exposing platform specific portions of the code.<br></br>
 * The user consent definition defines two kinds of dialogs:
 *
 *  * Navigation based user consents (see [UserConsentNavigator])
 *  * File dialogs (see [FileDialog])
 *
 * These types can be created by a user consent implementation which is represented by the [UserConsent]
 * interface.
 */
