 ...
 * @author Tobias Wich
 */
public class CGTrustStoreLoader extends TrustStoreLoader {

    @Override
    protected String getStoreFileName() {
	if (ChipGatewayProperties.isDeveloperTrustStore()) {
	    return "chipgateway/cg_truststore_dev.zip";
	} else {
	    return "chipgateway/cg_truststore.zip";
	}
    }
