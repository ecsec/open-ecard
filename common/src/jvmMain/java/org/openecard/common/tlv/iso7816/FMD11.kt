...
class FMD(private val tlv: TLV) {
     ...
     */
    var discretionaryDataTemplate: ByteArray?
        private set
     ...
     * file reference.
     */
    fun getReferences(): List<Pair<ByteArray?, ByteArray?>>? {
        return references
    }
     ...
     */
    fun getProprietaryInformation(): List<TLV?>? {
