...
final class ExtendedLengthAlertDialog implements Runnable {
	...
	// Add close button
	ad.setButton(lang.translationForKey("android.error.ext_apdu.quit"), new DialogInterface.OnClickListener() {
	    @Override
	...
	ad.setButton2(lang.translationForKey("android.error.ext_apdu.more"), new DialogInterface.OnClickListener() {
		...
		if (lang.equalsIgnoreCase("de")) {
		    i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.openecard.org/de/extendedLength"));
		} else {
		    i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.openecard.org/en/extendedLength"));
		}
