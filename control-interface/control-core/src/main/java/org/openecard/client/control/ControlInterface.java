...
public class ControlInterface {
	...
	this(binding, new ControlHandlers(), new ControlListeners());
    }
	...
	this(binding, handlers, new ControlListeners());
    }
     ...
     */
    public ControlInterface(ControlBinding binding, ControlHandlers handlers, ControlListeners listeners) {
	this.binding = binding;
	this.binding.setControlHandlers(handlers);
	this.binding.setControlListeners(listeners);
	this.listeners = listeners;
    }

    public ControlListeners getListeners(){
	return listeners;
    }
    /**
