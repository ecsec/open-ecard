...
public class RootHelper {
     ...
     * 
     * @param command
     *            the command that should be executed as root
     ...
     * 
     * @param os
     *            the OutputStream to which the command should be written
     * @param command
     *            the command that should be written to the OutputStream
     * @throws IOException
     *             if writing the command to the OutputStream fails
     */
