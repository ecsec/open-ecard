...
public class SubjectWhitelistTest {
	...
	try (InputStream certIn = SubjectWhitelistTest.class.getResourceAsStream("/cms_sign_cert.crt")) {
    ...
    @Test
    public void testGoodApiEndpoints() throws CertificateException {
	String goodCertStr = "-----BEGIN CERTIFICATE-----\n"
    ...
    @Test
    public void testBadApiEndpoints() throws CertificateException {
	String badCertStr = "-----BEGIN CERTIFICATE-----\n"
    ...
    private boolean matchApiEndpoint(String certStr) throws CertificateException {
	...
	return AllowedApiEndpoints.instance().isInSubjects(certSub);
    }
