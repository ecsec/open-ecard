 ...
 */
class HandlerUtils {
    fun createBuilder(): HandlerBuilder {
        return HandlerBuilder.Companion.create()
    }
    ...
    companion object {
        ...
        private fun copyPath(out: CardApplicationPathType, `in`: CardApplicationPathType) {
        ...
        fun extractHandle(@Nonnull obj: Any): ConnectionHandleType? {
            // SAL calls
            val handle = getMember(
                obj, "getConnectionHandle",
            ...
            val ctxHandle = getMember(
                obj, "getContextHandle",
        ...
        private fun <T> getMember(obj: Any, methodName: String, memberType: Class<T>): T? {
            try {
        ...
        fun print(@Nonnull handle: ConnectionHandleType): String {
            return print(handle, "", "  ")
        }
        ...
        fun print(
            ...
            @Nonnull prefixIncrement: String
        ): String {
            val p1 = prefix
