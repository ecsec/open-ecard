...
/**
 * Convenience class to create a logging settings add-on panel.
 * The panel only hosts a settings page to activate logging.
 *
 * @author Tobias Wich
 */
public class LogSettingsAddon extends AddonPanel {

    private static final long serialVersionUID = 1L;
    private static final I18n lang = I18n.getTranslation("addon");

    public LogSettingsAddon() {
	super(createAction(), lang.translationForKey("addon.list.core.logging"), null, loadLogo());
    }

    private static JPanel createAction() {
	return new LogSettingsPanel();
    }
