...
object WSHelper {
	...
	@JvmStatic
	fun <T : ResponseBaseType> minorIsOneOf(
		response: T,
		vararg minors: String,
	): Boolean {
		val r = response.result
	...
	@JvmStatic
	fun <T : ECardException> minorIsOneOf(
		ex: T,
		vararg minors: String,
	): Boolean {
		val r = ex.result
	 ...
	 */
	@JvmStatic
	fun createException(r: Result): WSException = WSException(r)
	...
	@JvmStatic
	fun <C : Class<T>, T : ResponseBaseType> makeResponse(
		c: C,
		r: Result,
	): T {
...
fun Result.toException(): WSHelper.WSException = WSHelper.createException(this)
