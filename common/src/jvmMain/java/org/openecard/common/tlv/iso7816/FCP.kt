...
class FCP
	...
	constructor(
		...
		private val fileIdentifiers: MutableList<ByteArray> = mutableListOf()
		private val dfNames: MutableList<ByteArray> = mutableListOf()
		private val proprietaryInformationNoTLV: MutableList<ByteArray> = mutableListOf()
		private val proprietarySecurityAttribute: MutableList<ByteArray> = mutableListOf()
		...
		init {
			...
			val descriptorBytes = mutableListOf<ByteArray>()
