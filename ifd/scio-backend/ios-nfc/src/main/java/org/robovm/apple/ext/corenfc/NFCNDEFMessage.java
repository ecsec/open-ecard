...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/NFCNDEFMessage/*</name>*/ 
    ...
    public NFCNDEFMessage(NSArray<NFCNDEFPayload> records) { super((SkipInit) null); initObject(initWithNDEFRecords(records)); }
     ...
     */
    @Method(selector = "initWithNDEFRecords:")
    protected native @Pointer long initWithNDEFRecords(NSArray<NFCNDEFPayload> records);
    /**
     * @since Available in iOS 13.0 and later.
     */
