...
class FCP(private val tlv: TLV) {
     ...
     */
    var shortEfIdentifier: ByteArray?
        private set
     ...
     */
    var securityAttributeReferenceExpanded: ByteArray?
        private set
     ...
     */
    var securityAttributeCompact: ByteArray?
        private set
     ...
     */
    var securityAttributeTemplateForDataObject: ByteArray?
        private set
     ...
     */
    var securityAttributeTemplateProprietary: ByteArray?
        private set
     ...
     */
    var securityAttributeTemplateExpanded: ByteArray?
        private set
     ...
     */
    var cryptographicMechanismIdentifierTemplate: ByteArray?
        private set
    ...
    init {
        ...
        var next: TLV
        while ((p.next(0).also { next = it!! }) != null) {
            // num bytes
     ...
     */
    fun getFileIdentifiers(): List<ByteArray?> {
     ...
     */
    fun getProprietaryInformationNoTLV(): List<ByteArray?> {
     ...
     */
    fun getProprietarySecurityAttribute(): List<ByteArray?> {
     ...
     */
    fun getSecurityEnvironmentTemplateEfs(): List<ByteArray?> {
     ...
     */
    fun getDataObjectTemplates(): List<TLV> {
