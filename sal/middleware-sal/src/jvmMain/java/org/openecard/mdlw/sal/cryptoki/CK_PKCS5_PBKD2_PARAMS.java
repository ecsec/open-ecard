...
public class CK_PKCS5_PBKD2_PARAMS extends Structure {
	...
	/** C type : CK_ULONG_PTR */
	public LongByReference ulPasswordLen;
	public LongByReference getUlPasswordLen() {
		return ulPasswordLen;
	}
	public void setUlPasswordLen(LongByReference ulPasswordLen) {
	 ...
	 * @param ulPasswordLen C type : CK_ULONG_PTR
	 */
	public CK_PKCS5_PBKD2_PARAMS(long saltSource, Pointer pSaltSourceData, long ulSaltSourceDataLen, long iterations, long prf, Pointer pPrfData, long ulPrfDataLen, Pointer pPassword, LongByReference ulPasswordLen) {
		super();
		this.saltSource = saltSource;
		this.pSaltSourceData = pSaltSourceData;
		this.ulSaltSourceDataLen = ulSaltSourceDataLen;
	...
	public CK_PKCS5_PBKD2_PARAMS(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends CK_PKCS5_PBKD2_PARAMS implements Structure.ByReference {
		
	};
	public static class ByValue extends CK_PKCS5_PBKD2_PARAMS implements Structure.ByValue {
