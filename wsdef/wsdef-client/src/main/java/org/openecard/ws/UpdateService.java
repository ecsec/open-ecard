...
public interface UpdateService {
    ...
    @ECardApiMethod(operationName = "CheckFrameworkUpdate", action = "http://www.bsi.bund.de/ecard/api/1.0#CheckFrameworkUpdate")
    public de.bund.bsi.ecard.api._1.CheckFrameworkUpdateResponse checkFrameworkUpdate(
        de.bund.bsi.ecard.api._1.CheckFrameworkUpdate parameters
    );
}
