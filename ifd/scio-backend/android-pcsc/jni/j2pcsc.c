...
#ifdef J2PCSC_DEBUG
#define dprintf(s) __android_log_print(ANDROID_LOG_DEBUG, "j2pcsc", s);
#define dprintf1(s, p1) __android_log_print(ANDROID_LOG_DEBUG, "j2pcsc", s, p1);
#define dprintf2(s, p1, p2) __android_log_print(ANDROID_LOG_DEBUG, "j2pcsc", s, p1, p2);
#define dprintf3(s, p1, p2, p3) __android_log_print(ANDROID_LOG_DEBUG, "j2pcsc", s, p1, p2, p3);
#else
#define dprintf(s)
...
#ifdef J2PCSC_DEBUG
{
    ...
    rv = SCardControl(card, jControlCode, sendBuffer, sendBufferLength,
