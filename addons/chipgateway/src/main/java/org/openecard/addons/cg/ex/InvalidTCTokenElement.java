 ...
 * @author Tobias Wich
 */
public class InvalidTCTokenElement extends FatalActivationError {

    public InvalidTCTokenElement(String msg) {
	super(new BindingResult(BindingResultCode.WRONG_PARAMETER), msg);
    }

    public InvalidTCTokenElement(String msg, Throwable ex) {
	super(new BindingResult(BindingResultCode.WRONG_PARAMETER), msg, ex);
    }

    public InvalidTCTokenElement(I18nKey key, Object... params) {
	super(new BindingResult(BindingResultCode.WRONG_PARAMETER), key, params);
    }

    public InvalidTCTokenElement(I18nKey key, Throwable cause, Object... params) {
