...
class CHAT {
     ...
     */
    fun getWriteAccess(): Map<DataGroup, Boolean> {
        return writeAccess.toMap()
    }
     ...
     */
    fun setWriteAccess(dataGroup: DataGroup, selected: Boolean): Boolean {
     ...
     * @return True if specialData group is set, otherwise false
     */
    fun setWriteAccess(dataGroup: String, selected: Boolean): Boolean {
     ...
     */
    fun getReadAccess(): Map<DataGroup, Boolean> {
        return readAccess.toMap()
    }
     ...
     */
    fun setReadAccess(dataGroup: DataGroup, selected: Boolean): Boolean {
     ...
     * @return True if the specialData group is set, otherwise false
     */
    fun setReadAccess(dataGroup: String, selected: Boolean): Boolean {
     ...
     */
    fun getSpecialFunctions(): Map<SpecialFunction, Boolean> {
        return specialFunctions.toMap()
    }
     ...
     */
    fun setSpecialFunctions(specialFunction: SpecialFunction, selected: Boolean): Boolean {
     ...
     * @return True if the special function is set, otherwise false
     */
    fun setSpecialFunction(specialFunction: String, selected: Boolean): Boolean {
     ...
     */
    fun getAccessRights(): Map<AccessRight, Boolean> {
        return accessRights.toMap()
    }
     ...
     */
    fun setAccessRights(accessRight: AccessRight, selected: Boolean): Boolean {
     ...
     * @return True if the access right is set, otherwise false
     */
    fun setAccessRights(accessRight: String, selected: Boolean): Boolean {
    ...
    companion object {
        private fun <T : Enum<T>> removeRights(orig: EnumMap<T, Boolean>, mask: EnumMap<T, Boolean>) {
