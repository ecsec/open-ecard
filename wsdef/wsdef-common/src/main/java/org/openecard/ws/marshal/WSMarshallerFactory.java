...
public class WSMarshallerFactory {
	...
	try {
	    ...
	    factory = new GenericFactory<>(WSMarshaller.class, WsdefProperties.properties(), key);
     ...
     */
    public static synchronized WSMarshaller createInstance() throws WSMarshallerException {
	if (inst == null) {
