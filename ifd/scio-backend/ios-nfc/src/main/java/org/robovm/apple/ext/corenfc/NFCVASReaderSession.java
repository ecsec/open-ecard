...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/NFCVASReaderSession/*</name>*/ 
    ...
    public NFCVASReaderSession(NSArray<NFCVASCommandConfiguration> commandConfigurations, NFCVASReaderSessionDelegate delegate, DispatchQueue queue) { super((SkipInit) null); initObject(initWithVASCommandConfigurations$delegate$queue$(commandConfigurations, delegate, queue)); }
    /*</constructors>*/
    /*<properties>*/
     ...
     */
    @Method(selector = "initWithVASCommandConfigurations:delegate:queue:")
    protected native @Pointer long initWithVASCommandConfigurations$delegate$queue$(NSArray<NFCVASCommandConfiguration> commandConfigurations, NFCVASReaderSessionDelegate delegate, DispatchQueue queue);
    /*</methods>*/
}
