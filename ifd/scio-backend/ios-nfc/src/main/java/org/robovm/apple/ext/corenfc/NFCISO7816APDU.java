...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/NFCISO7816APDU/*</name>*/ 
    ...
    public NFCISO7816APDU(byte instructionClass, byte instructionCode, byte p1Parameter, byte p2Parameter, NSData data, @MachineSizedSInt long expectedResponseLength) { super((SkipInit) null); initObject(initWithInstructionClass$instructionCode$p1Parameter$p2Parameter$data$expectedResponseLength$(instructionClass, instructionCode, p1Parameter, p2Parameter, data, expectedResponseLength)); }
    @Method(selector = "initWithData:")
    public NFCISO7816APDU(NSData data) { super((SkipInit) null); initObject(initWithData(data)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    /*<methods>*/
    @Method(selector = "initWithInstructionClass:instructionCode:p1Parameter:p2Parameter:data:expectedResponseLength:")
    protected native @Pointer long initWithInstructionClass$instructionCode$p1Parameter$p2Parameter$data$expectedResponseLength$(byte instructionClass, byte instructionCode, byte p1Parameter, byte p2Parameter, NSData data, @MachineSizedSInt long expectedResponseLength);
    @Method(selector = "initWithData:")
