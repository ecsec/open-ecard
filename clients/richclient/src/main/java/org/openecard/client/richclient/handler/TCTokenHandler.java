...
import org.openecard.client.richclient.activation.io.CustomStringBuilder;
 ...
 */
public class TCTokenHandler implements ActivationHandler {
...
//		    }
	    ...
	    String message = ActivationConstants.ActivationError.BAD_REQUEST.toString();
	    throw new ActivationException(message, e);
	} catch (IOException e) {
	    String message = ActivationConstants.ActivationError.BAD_REQUEST.toString();
	    throw new ActivationException(message, e);
	} catch (Throwable e) {
	    String message = ActivationConstants.ActivationError.INTERNAL_ERROR.toString();
	    throw new ActivationException(message, e);
	}
    }
	...
	if (clientResponse instanceof TCTokenResponse) {
		...
		handleErrorResponse(ActivationConstants.ActivationError.INTERNAL_ERROR.toString());
	    }
	}
	return null;
    }
