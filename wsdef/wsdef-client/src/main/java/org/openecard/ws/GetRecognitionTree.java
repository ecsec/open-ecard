...
public interface GetRecognitionTree {
    ...
    @ECardApiMethod(operationName = "GetRecognitionTree", action = "urn:iso:std:iso-iec:24727:tech:schema:GetRecognitionTree")
    public iso.std.iso_iec._24727.tech.schema.GetRecognitionTreeResponse getRecognitionTree(
        iso.std.iso_iec._24727.tech.schema.GetRecognitionTree parameters
    );
}
