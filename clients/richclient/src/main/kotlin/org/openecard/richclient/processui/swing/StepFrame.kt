...
import org.openecard.richclient.processui.swing.common.NavigationEvent
import org.openecard.richclient.processui.swing.components.Focusable
import org.openecard.richclient.processui.swing.components.StepComponent
import org.openecard.richclient.processui.swing.steplayout.StepLayouter
...
class StepFrame(
	...
	fun getStepResult(): StepResult = stepResult
	 ...
	 * Before a button is clicked by the user, the [org.openecard.richclient.processui.executor.ExecutionEngine] waits for the
