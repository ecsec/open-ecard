 ...
 */
/**
 * Executor implementation for user consents. <br></br>
 * The [ExecutionEngine] is a helper to display the steps of a user consent. It displays one after the other
 * and reacts differently depending of the outcome of a step. The [StepAction] class adds the possibility to run
