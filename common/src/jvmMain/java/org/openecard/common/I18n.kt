...
class I18n private constructor(
	private val loaderReference: Class<*>,
	component: String,
) {
	private val component: String
	private val translation: Properties
	private val original: Properties
	private val translatedFiles: MutableMap<String, URL?>
	 ...
	 */
	fun associatedComponent(): String = component
	...
	fun translationForKey(
		key: I18nKey,
		vararg parameters: Any?,
	): String = translationForKey(key.key, *parameters)
	 ...
	 */
	fun translationForFile(name: String): URL = translationForFile(name, null)
	...
	fun getOriginalMessage(
		key: I18nKey,
		vararg parameters: Any?,
	): String = getOriginalMessage(key.key, *parameters)
