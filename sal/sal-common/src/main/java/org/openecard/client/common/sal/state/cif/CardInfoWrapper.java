...
public class CardInfoWrapper {
     ...
     * 
     * @param cif
     *            the CardInfo that should be wrapped
     */
	...
	CardApplicationWrapper application = this.getCardApplications()
		.get(new ByteArrayWrapper(applicationIdentifier));
	if (application == null)
	    return null;
     ...
     * 
     * @param didName
     *            Name of the DID to get the structure for
     * @param cardApplication
     *            Identifier of the card application
