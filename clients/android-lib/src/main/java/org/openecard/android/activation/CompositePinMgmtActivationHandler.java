...
/**
 * Implementation of the PinMgmtActivationHandler which uses a composite object to provide the missing functions.
 *
 * @author Tobias Wich
 */
public final class CompositePinMgmtActivationHandler extends PinMgmtActivationHandler<Activity> {
     ...
     */
    public CompositePinMgmtActivationHandler(Activity a, ActivationCallbackInterface cbObj) {
	super(a);
	this.cbObj = cbObj;
    }
    ...
    @Override
    public void onGuiIfaceSet(PINManagementGui androidGui) {
