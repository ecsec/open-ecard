...
class EfCardAccessTest {
	...
	@OptIn(ExperimentalUnsignedTypes::class)
	val efCaNpaWithExtrabytes =
		hex(
			"",
		)
	...
	@OptIn(ExperimentalUnsignedTypes::class)
	@Test
	fun `deserialize EF_CA data nPa with extra non-TLV data`() {
		val efca = efCaNpaWithExtrabytes.toEfCardAccess()
		val secInfos = efca.secInfos
		assertEquals(6, secInfos.size)
		val paceInfo = efca.paceInfo.firstOrNull()?.info
		assertEquals(
