 ...
 * @author Tobias Wich
 */
class ImageBox : IDTrait(), InputInfoUnit {
    ...
    var imageData: ByteArray
         ...
         */
        get() {
            val imageData = document.getValue()
         ...
         */
        set(imageData) {
            document.setValue(imageData.copyOf(imageData.size))
        }
    ...
    companion object {
        private val LOG: Logger = LoggerFactory.getLogger(ImageBox::class.java)
    }
}
