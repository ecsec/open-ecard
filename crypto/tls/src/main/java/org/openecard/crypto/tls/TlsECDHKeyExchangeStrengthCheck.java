 ...
 * @author Tobias Wich
 */
public class TlsECDHKeyExchangeStrengthCheck extends TlsECDHKeyExchange {

    public TlsECDHKeyExchangeStrengthCheck(int keyExchange, Vector supportedSigAlgs, int[] namedCurves,
