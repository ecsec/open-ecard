...
private fun createSut(
	...
	return NFCCardMonitoring(terminal, nfcCard)
}

private fun createTerminal(): NFCCardTerminal<*> {
	return Mockito.mock(NFCCardTerminal::class.java)
}

private fun createNfcCard(): AbstractNFCCard {
	return Mockito.mock(AbstractNFCCard::class.java)
}
