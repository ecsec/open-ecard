...
object ByteUtils {
     ...
     */
    @JvmStatic
    fun concatenate(x: ByteArray?, y: ByteArray?): ByteArray? {
        if (x == null) {
            return y
        }
        if (y == null) {
     ...
     */
    @JvmStatic
    fun concatenate(x: Byte, y: ByteArray?): ByteArray? {
        return concatenate(byteArrayOf(x), y)
    }
     ...
     */
    @JvmStatic
    fun concatenate(x: ByteArray?, y: Byte): ByteArray? {
        return concatenate(x, byteArrayOf(y))
    }
     ...
     */
    @JvmStatic
    fun concatenate(x: Byte, y: Byte): ByteArray? {
        return concatenate(byteArrayOf(x), byteArrayOf(y))
    }
     ...
     */
    @JvmStatic
    fun copy(input: ByteArray?, offset: Int, length: Int): ByteArray? {
        if (input == null) {
            return null
        }
     ...
     */
    @JvmStatic
    fun compare(x: ByteArray?, y: ByteArray?): Boolean {
        if (y == null || x == null) {
            return false
        }
        if (x.size != y.size) {
     ...
     */
    @JvmStatic
    fun compareUnsigned(x: ByteArray?, y: ByteArray?): Int {
     ...
     */
    @JvmStatic
    fun compare(x: Byte, y: ByteArray?): Boolean {
        return compare(byteArrayOf(x), y)
    }
     ...
     */
    @JvmStatic
    fun compare(x: ByteArray?, y: Byte): Boolean {
        return compare(x, byteArrayOf(y))
    }
     ...
     */
    @JvmStatic
    fun compare(x: Byte, y: Byte): Boolean {
        return compare(byteArrayOf(x), byteArrayOf(y))
    }
     ...
     */
    fun isPrefix(prefix: ByteArray?, data: ByteArray?): Boolean {
     ...
     */
    fun isPrefix(prefix: Byte, data: ByteArray?): Boolean {
        return isPrefix(byteArrayOf(prefix), data)
    }
     ...
     */
    @JvmStatic
    fun toHexString(bytes: ByteArray?, formatted: Boolean): String? {
     ...
     */
    @JvmStatic
    fun toHexString(bytes: ByteArray?, formatted: Boolean, addLinebreak: Boolean): String? {
        return if (formatted) {
    ...
    private fun toHexString(bytes: ByteArray?, format: String, addLinebreak: Boolean): String? {
        if (bytes == null) {
            return null
        }
     ...
     */
    @JvmStatic
    fun toWebSafeBase64String(bytes: ByteArray?): String? {
     ...
     */
    @JvmOverloads
    fun toFileSafeBase64String(bytes: ByteArray?, withPadding: Boolean = true): String? {
        if (bytes == null) {
            return null
        }

        var result: String = FileSafeBase64.Companion.toBase64String(bytes)
        if (!withPadding) {
    ...
    @JvmStatic
    @JvmOverloads
    fun toShort(bytes: ByteArray, bigEndian: Boolean = true): Short {
    ...
    @JvmStatic
    @JvmOverloads
    fun toInteger(bytes: ByteArray, bigEndian: Boolean = true): Int {
        require(!(bytes.size > 4 || bytes.size < 1)) { "Size of byte array must be between 1 and 4." }
    ...
    fun toLong(bytes: ByteArray, bigEndian: Boolean = true): Long {
        require(!(bytes.size > 8 || bytes.size < 1)) { "Size of byte array must be between 1 and 8." }
    ...
    fun isBitSet(position: Int, array: ByteArray): Boolean {
    ...
    @JvmStatic
    @Throws(IllegalArgumentException::class)
    fun setBit(position: Int, array: ByteArray) {
        require(!(position < 0 || position >= array.size * 8)) { "Position is invalid" }
