 ...
 */
public class GenericSecretKeyObject <ObjectType> {
    ...
    private TLV subClassAttributes;       // CommonSecretKeyAttributes
    private ObjectType typeAttributes; // DataObjectAttributes

    public GenericSecretKeyObject(TLV tlv, Class<ObjectType> clazz) throws TLVException {
