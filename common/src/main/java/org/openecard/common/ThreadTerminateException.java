 ...
 * @author Tobias Wich
 */
public class ThreadTerminateException extends RuntimeException {

    public ThreadTerminateException(String msg) {
	super(msg);
    }

    public ThreadTerminateException(String msg, Throwable cause) {
	super(msg, cause);
    }
