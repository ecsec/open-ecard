...
open class ManageSecurityEnvironment : CardCommandAPDU {
	 ...
	 */
	protected constructor(p1: Byte, p2: Byte) : super(x00, COMMMAND_MSESet_AT, p1, p2)
	 ...
	 * @param data Data
	 */
	constructor(p1: Byte, p2: Byte, data: ByteArray?) : super(x00, COMMMAND_MSESet_AT, p1, p2) {
		this.data = data!!
	}
	...
	class Store(
		p2: Byte,
	) : ManageSecurityEnvironment(0xF2.toByte(), p2)

	class Restore(
		p2: Byte,
	) : ManageSecurityEnvironment(0xF3.toByte(), p2)

	class Erase(
		p2: Byte,
	) : ManageSecurityEnvironment(0xF4.toByte(), p2)
