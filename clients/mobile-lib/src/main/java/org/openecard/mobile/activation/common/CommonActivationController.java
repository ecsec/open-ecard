...
class CommonActivationController implements ActivationController {
    ...
    public CommonActivationController(URL requestURI, String protocolType, ActivationControllerService activationControllerService, ControllerCallback activation) {
    ...
    @Override
    public void start() {
	this.activationControllerService.start(this.requestURI, this.activation);
    }
