 ...
 */
public class CK_CCM_PARAMS extends Structure {
	/** C type : CK_ULONG */
	 ...
	 */
	public CK_CCM_PARAMS(long ulDataLen, Pointer pNonce, long ulNonceLen, Pointer pAAD, long ulAADLen, long ulMACLen) {
		super();
		this.ulDataLen = ulDataLen;
		this.pNonce = pNonce;
		this.ulNonceLen = ulNonceLen;
	...
	public CK_CCM_PARAMS(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends CK_CCM_PARAMS implements Structure.ByReference {
		
	};
	public static class ByValue extends CK_CCM_PARAMS implements Structure.ByValue {
