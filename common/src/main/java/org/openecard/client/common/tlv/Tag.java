...
public class Tag {
    ...
    public static final Tag BooleanTag = new Tag(TagClass.UNIVERSAL, true, 1);
    public static final Tag IntegerTag = new Tag(TagClass.UNIVERSAL, true, 2);
    public static final Tag BitstringTag = new Tag(TagClass.UNIVERSAL, true, 3); // primitive or constructed
    public static final Tag OctetstringTag = new Tag(TagClass.UNIVERSAL, true, 4); // primitive or constructed
    public static final Tag NullTag = new Tag(TagClass.UNIVERSAL, true, 5);
    public static final Tag OIDTag = new Tag(TagClass.UNIVERSAL, true, 6);
    ...
    public static final Tag RealTag = new Tag(TagClass.UNIVERSAL, true, 9);
    public static final Tag EnumeratedTag = new Tag(TagClass.UNIVERSAL, true, 10);
    public static final Tag EmbeddedPDVTag = new Tag(TagClass.UNIVERSAL, false, 11);
    //public static final Tag UTF8Tag = new Tag(TagClass.UNIVERSAL, true, 12);
    public static final Tag RelativeOIDTag = new Tag(TagClass.UNIVERSAL, true, 13);
    //public static final Tag TimeTag = new Tag(TagClass.UNIVERSAL, true, 14);
    // 15 is reserved for future recommendations
    public static final Tag SequenceTag = new Tag(TagClass.UNIVERSAL, false, 16);
    public static final Tag SetTag = new Tag(TagClass.UNIVERSAL, false, 17);
