 ...
 * @author Tobias Wich
 */
abstract class AbstractTextField(id: String) : IDTrait(id), InputInfoUnit, OutputInfoUnit {
    /**
    ...
    companion object {
        private val LOG: Logger = LoggerFactory.getLogger(AbstractTextField::class.java)
    }
}
