...
public class Service {
	...
	for (Method m : methods) {
		...
		if (requestMethods.containsKey(reqClass.getName())) {
		    _logger.log(Level.WARNING, "Omitting method {0} in srvice interface {1} because its parameter type is already associated with another method.", new Object[]{m.getName(), iface.getName()});
		} else {
