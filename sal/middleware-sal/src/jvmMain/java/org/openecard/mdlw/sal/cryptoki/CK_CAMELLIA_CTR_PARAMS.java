 ...
 */
public class CK_CAMELLIA_CTR_PARAMS extends Structure {
	/** C type : CK_ULONG */
	 ...
	 */
	public CK_CAMELLIA_CTR_PARAMS(long ulCounterBits, byte cb[]) {
		super();
		this.ulCounterBits = ulCounterBits;
	...
	public CK_CAMELLIA_CTR_PARAMS(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends CK_CAMELLIA_CTR_PARAMS implements Structure.ByReference {
		
	};
	public static class ByValue extends CK_CAMELLIA_CTR_PARAMS implements Structure.ByValue {
