...
import org.openecard.common.util.LongUtils.toByteArray
...
class Tag( // char strings 18-22, 25-30
	...
	fun getTagClass(): TagClass? = tagClass
	...
	fun isPrimitive(): Boolean = this.primitive
	...
	fun getTagNum(): Long = this.tagNum
