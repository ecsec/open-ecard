...
object GraphicsUtil {
     ...
     */
    /**
     * Creates an image with the specified width and height. <br></br><br></br>
     *
     * The class passed to this method **must** have been created using
     * [SVG2Java](https://code.google.com/p/svg2java/).
     *
    ...
    @JvmOverloads
    fun createImage(
        clazz: Class<out Icon>, imageWidth: Int, imageHeight: Int, canvasWidth: Int = imageWidth,
        canvasHeight: Int = imageHeight, posX: Int = 0, posY: Int = 0
    ): Image {
