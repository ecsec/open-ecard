 ...
 * @author Tobias Wich
 */
public abstract class AbstractMarkerType {

    protected final DIDAbstractMarkerType marker;

    protected AbstractMarkerType(DIDAbstractMarkerType marker) {
	this.marker = marker;
    }
