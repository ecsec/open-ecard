...
object LinuxLibraryFinder {
	...
	private fun findInLdCache(libname: String): File? {
	...
	private fun findProgramFile(name: String): String {
	...
	private fun findInBaseLibPaths(libname: String): File? {
