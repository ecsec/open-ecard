 ...
 * @author Tobias Wich
 */
public class TlsECDHEKeyExchangeStrengthCheck extends TlsECDHEKeyExchange {

    public TlsECDHEKeyExchangeStrengthCheck(int keyExchange, Vector supportedSigAlgs, int[] namedCurves,
	    short[] clientECPointFormats, short[] serverECPointFormats) {
	super(keyExchange, supportedSigAlgs, namedCurves, clientECPointFormats, serverECPointFormats);
    }
