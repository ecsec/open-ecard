 ...
 * @author Tobias Wich
 */
public class MobileResult implements StepResult {
    ...
    public MobileResult(Step step, ResultStatus status, List<OutputInfoUnit> outputUnits) {
	this(step, status, outputUnits, null);
    }

    public MobileResult(Step step, ResultStatus status, List<OutputInfoUnit> outputUnits, @Nullable Step replacement) {
	this.step = step;
	this.status = status;
