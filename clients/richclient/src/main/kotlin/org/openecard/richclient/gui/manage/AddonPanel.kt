...
open class AddonPanel : JPanel {
     ...
     */
    constructor(
        actionPanel: ActionPanel?, settingsPanel: SettingsPanel?,
        aboutPanel: AboutPanel?, name: String, description: String?, logo: Image?
    ) {
     ...
     */
    constructor(
        singlePanel: JPanel, name: String, description: String?,
        logo: Image?
    ) {
        setLayout(BorderLayout(0, 0))
        this.logo = logo
     ...
     */
    fun getLogo(): Image {
        return logo?.getScaledInstance(LOGO_WIDTH, LOGO_HEIGHT, Image.SCALE_SMOOTH) ?: defaultLogo
    }

    private fun createHeader(name: String, description: String?) {
    ...
    private val defaultLogo: Image
        get() {
            val original: Image = GraphicsUtil.createImage(
                OecLogo::class.java,
                LOGO_WIDTH,
                LOGO_HEIGHT
            )
            val result: BufferedImage = BufferedImage(
                LOGO_WIDTH,
                LOGO_HEIGHT,
