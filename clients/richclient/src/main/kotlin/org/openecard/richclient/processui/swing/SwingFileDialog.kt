...
import org.openecard.richclient.processui.file.FileDialogResult
import org.openecard.richclient.processui.file.FileFilter
import org.openecard.richclient.processui.swing.common.GUIDefaults
import org.openecard.richclient.processui.swing.file.SwingFileFilterWrapper
...
class SwingFileDialog : FileDialog {
	private val dialog: JFileChooser =
		object : JFileChooser() {
