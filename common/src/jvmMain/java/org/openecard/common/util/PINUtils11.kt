 ...
 */
object PINUtils {
    private val LOG: Logger = LoggerFactory.getLogger(PINUtils::class.java)
    ...
    fun buildVerifyTransmit(
        rawPIN: CharArray, attributes: PasswordAttributesType, template: ByteArray?,
    ...
    @Throws(UtilException::class)
    fun encodePin(rawPin: CharArray, attributes: PasswordAttributesType): ByteArray? {
        // extract attributes
    ...
    @Throws(UnsupportedEncodingException::class, UtilException::class)
    fun encodeTextPin(
        encoding: String?, rawPin: CharArray, minLen: Int, storedLen: Int, maxLen: Int,
        needsPadding: Boolean, padChar: Byte
    ): ByteArray? {
    ...
    @Throws(UtilException::class, IOException::class)
    fun encodeBcdPin(
        pwdType: PasswordTypeType, rawPin: CharArray, minLen: Int, storedLen: Int, maxLen: Int,
        needsPadding: Boolean, padChar: Byte
    ): ByteArray {
    ...
    @Throws(UtilException::class)
    private fun getPadChar(attributes: PasswordAttributesType, needsPadding: Boolean): Byte {
