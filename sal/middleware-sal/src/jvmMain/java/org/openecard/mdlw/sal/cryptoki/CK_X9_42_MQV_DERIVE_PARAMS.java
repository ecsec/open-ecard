 ...
 */
public class CK_X9_42_MQV_DERIVE_PARAMS extends Structure {
	...
	public CK_X9_42_MQV_DERIVE_PARAMS() {
		super();
	}
	 protected List<String> getFieldOrder() {
		return Arrays.asList("kdf", "ulOtherInfoLen", "pOtherInfo", "ulPublicDataLen", "pPublicData", "ulPrivateDataLen", "hPrivateData", "ulPublicDataLen2", "pPublicData2", "publicKey");
	}
	public CK_X9_42_MQV_DERIVE_PARAMS(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends CK_X9_42_MQV_DERIVE_PARAMS implements Structure.ByReference {
		
	};
	public static class ByValue extends CK_X9_42_MQV_DERIVE_PARAMS implements Structure.ByValue {
