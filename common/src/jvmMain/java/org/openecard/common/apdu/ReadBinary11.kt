...
class ReadBinary : CardCommandAPDU {
     ...
     */
    constructor() : super(CardAPDU.Companion.x00, READ_BINARY_INS_1, CardAPDU.Companion.x00, CardAPDU.Companion.xFF)
     ...
     * @param offset Offset
     */
    constructor(offset: Byte) : super(CardAPDU.Companion.x00, READ_BINARY_INS_1, offset, CardAPDU.Companion.xFF)
     ...
     */
    constructor(offset: Byte, length: Byte) : super(CardAPDU.Companion.x00, READ_BINARY_INS_1, offset, length)
    ...
    constructor(offset: Short, length: Short) {
        ...
        p2 = (offset.toInt() and CardAPDU.Companion.xFF.toInt()).toByte()
        setLE(length)
    }
    ...
    override fun makeTransmit(slotHandle: ByteArray?): Transmit {
        val defaultResponses: ArrayList<ByteArray?> = object : ArrayList<ByteArray?>() {
            init {
