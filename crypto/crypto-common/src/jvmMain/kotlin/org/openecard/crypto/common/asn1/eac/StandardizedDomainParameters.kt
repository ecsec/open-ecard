 ...
 */
class StandardizedDomainParameters(index: Int) : DomainParameters(getDomainParameter(index)) {
	...
	companion object {
		...
		init {
			val gfp_1024_160 = ElGamalParameterSpec(
				BigInteger(
			...
			val gfp_2048_224 = ElGamalParameterSpec(
				BigInteger(
			...
			val gfp_2048_256 = ElGamalParameterSpec(
				BigInteger(
