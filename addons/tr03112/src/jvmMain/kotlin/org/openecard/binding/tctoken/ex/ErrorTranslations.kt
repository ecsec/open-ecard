 ...
 */
enum class ErrorTranslations(private val key: String) : I18nKey {
    ...
    CERT_DESCRIPTION_CHECK_FAILED("certificate.description.check.error"),
    ...
    MESSAGE_CONTENT_INVALID("message.validation.failed"),
