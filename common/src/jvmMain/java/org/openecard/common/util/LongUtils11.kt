...
object LongUtils {
     ...
     */
    @JvmOverloads
    fun toByteArray(value: Long, numBits: Int = 8, bigEndian: Boolean = true): ByteArray? {
     ...
     */
    @JvmOverloads
    fun toByteArray(value: Long, padArrayToTypeLength: Boolean, bigEndian: Boolean = true): ByteArray? {
