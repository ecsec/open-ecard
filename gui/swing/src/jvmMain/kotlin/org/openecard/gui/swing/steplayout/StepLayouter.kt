...
abstract class StepLayouter {
    ...
    companion object {
         ...
         */
        fun create(infoUnits: MutableList<InputInfoUnit>, dialogType: String, stepName: String): StepLayouter {
...
//	}
            ...
            if (dialogType == "pin_entry_dialog" || dialogType == "pin_change_dialog" || dialogType == "update_dialog") {
