 ...
 */
public class CK_SSL3_MASTER_KEY_DERIVE_PARAMS extends Structure {
	...
	public CK_SSL3_MASTER_KEY_DERIVE_PARAMS() {
	 ...
	 protected List<String> getFieldOrder() {
		return Arrays.asList("RandomInfo", "pVersion");
	}
	/**
	 * @param RandomInfo C type : CK_SSL3_RANDOM_DATA<br>
	 * @param pVersion C type : CK_VERSION_PTR
	 */
	public CK_SSL3_MASTER_KEY_DERIVE_PARAMS(CK_SSL3_RANDOM_DATA RandomInfo, org.openecard.mdlw.sal.cryptoki.CK_VERSION.ByReference pVersion) {
		super();
		this.RandomInfo = RandomInfo;
		this.pVersion = pVersion;
	}
	public CK_SSL3_MASTER_KEY_DERIVE_PARAMS(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends CK_SSL3_MASTER_KEY_DERIVE_PARAMS implements Structure.ByReference {
		
	};
	public static class ByValue extends CK_SSL3_MASTER_KEY_DERIVE_PARAMS implements Structure.ByValue {
