 ...
 */
    (id: String) : IDTrait(id), InputInfoUnit, OutputInfoUnit {
    /**
    ...
    override fun copyContentFrom(origin: InfoUnit) {
        if (!(this.javaClass == origin.javaClass)) {
            _logger.warn("Trying to copy content from type {} to type {}.", origin.javaClass, this.javaClass)
            return
        }
    ...
    companion object {
        private val _logger: Logger = LoggerFactory.getLogger(AbstractBox::class.java)
    }
}
