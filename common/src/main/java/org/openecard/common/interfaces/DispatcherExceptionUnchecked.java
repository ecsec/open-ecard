 ...
 * @author Tobias Wich
 */
public class DispatcherExceptionUnchecked extends RuntimeException {
     ...
     */
    public DispatcherExceptionUnchecked(String message) {
	super(message);
    }
     ...
     */
    public DispatcherExceptionUnchecked(String message, Throwable cause) {
	super(message, cause);
    }
