...
//	dataToSendSelection.getBoxItems().add(ageverificationBoxItem);
    ...
    private class RequestedDataAction(private val step: Step) : StepAction(
        step
    ) {
...
//			    }
    ...
    private class PinInputAction(step: Step, private val requestedData_Step1: Step) : StepAction(step) {
        override fun perform(
            oldResults: MutableMap<String?, ExecutionResults?>?,
            result: StepResult
        ): StepActionResult {
